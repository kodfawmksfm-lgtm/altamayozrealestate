...
const milestones = [
  ...
  { year: "2018", title: "توسع الخدمات", description: "أضفنا خدمات التمويل وإعادة هيكلة القروض" },
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="card-hover">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  أن نكون الشركة الرائدة والموثوقة في تقديم الحلول التمويلية المتكاملة في المملكة العربية السعودية، 
            ...
            <Card className="card-hover">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  تقديم حلول تمويلية شاملة ومتميزة تساعد عملاءنا على تحقيق أهدافهم، 
