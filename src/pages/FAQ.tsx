...
const generalFAQs: FAQItem[] = [
  {
    question: "ما هي مكتب تمكين للحلول التمويلية؟",
    answer: "مكتب تمكين للحلول التمويلية هي شركة سعودية متخصصة في تقديم الحلول التمويلية المتكاملة في مدينة الرياض. نقدم خدمات التمويل الشخصي، التطوير العقاري، الاستثمار، توفير العقارات الجاهزة، التصميم والترميم، ومتابعة الطلبات الحصري. جميع خدماتنا تتم وفق الأنظمة السعودية المعتمدة.",
  },
  {
...
const financingFAQs: FAQItem[] = [
  {
    question: "ما هي خدمة التمويل الشخصي؟",
    answer: "خدمة التمويل الشخصي تمكنك من تحويل قرضك العقاري الحالي إلى سيولة نقدية. نقوم بشراء عقار مناسب عن طريق جهة التمويل الخاصة بك، ثم نقوم بشرائه منك بسعر عادل يتيح لك الحصول على المبلغ النقدي الذي تحتاجه. جميع العمليات تتم بعقود رسمية موثقة.",
  },
  {
...
const investmentFAQs: FAQItem[] = [
  {
    ...
    answer: "نقدم فرصاً استثمارية متنوعة في قطاع التمويل السعودي تشمل: الاستثمار في المشاريع السكنية، التجارية، والأراضي. جميع الفرص تخضع لدراسة شاملة ويتم تقديم تقارير واضحة عن المخاطر والعوائد المتوقعة.",
  },
  {
    question: "هل إعادة هيكلة القروض يضمن عوائد مالية؟",
    ...
    <Layout>
      ...
      <section className="section-padding bg-background">
        <div className="container-rtl space-y-16">
          ...
          {/* Financing */}
          <div>
            <Badge className="mb-4 bg-gold/10 text-gold">التمويل الشخصي</Badge>
            <FAQSection items={financingFAQs} />
          </div>

          {/* Investment */}
          <div>
            <Badge className="mb-4 bg-trust/10 text-trust">إعادة هيكلة القروض</Badge>
